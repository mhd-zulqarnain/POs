...
public class LocalProduct
{
    ...
    @Expose
    @Ignore private List<LocalVariant> variants = new ArrayList<LocalVariant>();
    ...
    public LocalProduct(String categoryId, String categoryName, String subcategoryId, String subcategoryName, String storeProductId, List<String> productImages, List<String> productTags, String productName, String smallDescription, String productMrp, String offerPrice, String storeRangeId, String currencyId, String currencyTitle, String rangeName, String unitName, String unlimitedStock, String outOfStock, String purchaseLimit, String stockBalance, List<LocalVariant> variants, boolean isEdit, String productImagesArray) {
     ...
     * The variants
     */
    public List<LocalVariant> getVariants()
    {
        return variants;
    }
     ...
     * The variants
     */
    public void setVariants(List<LocalVariant> variants)
    {
        this.variants = variants;
    }
